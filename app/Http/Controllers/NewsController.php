...
class NewsController extends Controller {
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('featured_image')) {
            $newsData['featured_image'] = UploadImage::upload($request->file('featured_image'), 'news_images', 600, null);
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('featured_image')) {
            $news->featured_image = UploadImage::upload($request->file('featured_image'), 'news_images', 600, null);
        }

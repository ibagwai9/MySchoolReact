...
class ChildsAccountController extends Controller {
	...
	{
        $students = Student::where('parent_id', Auth::user()->userable_id)->get();
        
		return view('pages.guardian.childs.home', compact('students'));
	}
	...
	public function create()
	{
		...
		return view('pages.guardian.childs.create', compact('classes'));
	}
	...
	public function store(Request $request)
	{
       ...
       // return dd($request->school_id);
        ...
        return view('pages.guardian.childs.details')->with('details', $student);
	}
	...
	public function show($id)
	{
        ...
        return view('pages.guardian.childs.show')->with(['student'=> $student,'msg'=>false]);
	}
	...
	{
		$student = Student::find($id);
        return view('pages.guardian.childs.edit')->with('student', $student);
	}
	...
	public function update(Request $request, $id)
	{
        ...
        if ($student->save())
            return view('pages.guardian.childs.details')->with(['details'=>$student, 'update'=>true]);
    ...
    public function all()
    {
        ...
        return view('pages.guardian.childs.all')->with('students', $students);
    }

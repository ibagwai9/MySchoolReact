...
@section('content')
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div data-p="225.00" style="display: none;">
                <img data-u="image" src="{{ asset('img/slide01.jpg') }}" />
            </div>
            <div data-p="225.00" style="display: none;">
    ...
    <div class="wrapper bgded" style="background-image: url('{{asset('img/background.jpg')}}');">
        <div class="overlay">
    ...
    <div class="wrapper row3">
        <main class="container clear">
            ...
            <ul class="nospace group">
                @if(\App\NewsBoard::orderBy('created_at', 'DESC')->take(3)->count() > 0)
                    @foreach(\App\NewsBoard::orderBy('created_at', 'DESC')->take(3)->get() as $key=>$item)
                        @if($key == 0)
                            <li class="one_third btmspace-50 first">
                                <article class="service">
                                    <a href="/page/show-news/{{$item->id}}"><h3 class="heading">{{$item->title}}</h3></a>
                                    <p>{{Str::limit($item->news, $limit = 100, $end = "...")}}.</p>
                                </article>
                            </li>
                            @else
    ...
    <div class="wrapper bgded row4" style="background-image: url('{{asset('img/home/back.png')}}');">
        <div class="overlay">
            <footer id="footer" class="clear">

                <div class="one_quarter first">
                    <h6 class="title">{{thisCollege()->name}}</h6>
                    <address class="btmspace-15">
                        {{thisCollege()->address}}<br />
                        PMB: {{thisCollege()->pmb}}
                    </address>
                    <ul class="nospace">
                        <li class="btmspace-10"><span class="fa fa-phone"></span>{{thisCollege()->phone}}</li>
                        <li><span class="fa fa-envelope-o"></span>{{thisCollege()->email}}</li>
                    </ul>
                </div>
                <div class="one_quarter">
                    ...
                    <ul class="nospace linklist">
                        ...
                        <li><a href="/page/about">About App</a></li>

...
@section('content')
    <div class="container well well-lg">
        <div class="row">
            ...
            <div class="col-sm-12">
                <p class="text-info">App Nursery and Basic School is the school opened to educate and train the future leaders.
                    Today, there are many mushroom schools existing yet the standard of education is falling daily.
                    But App Nursery and Basic school has always attain for the highest standard and that what set us apart from the rest.
                </p>
                <p class="text-info">
                    The name App implies the name of the Elijah and Hannah, the children of Mr/Mrs Oduwole the proprietor and proprietress of the school.
                </p>
                <p class="text-info">

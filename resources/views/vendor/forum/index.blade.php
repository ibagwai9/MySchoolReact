            ...
            <td>
				...
				<div class="text-muted">
                    ...
                    <a href="{{ $subcategory->newestThread->route }}">
                        ...
                        ({{ \App\User::where('username', $subcategory->newestThread->authorName)->first()->userable->name}})</a>
                    ...
                    <a href="{{ $subcategory->latestActiveThread->lastPost->route }}">
                        ...
                        ({{ \App\User::where('username', $subcategory->latestActiveThread->lastPost->authorName)->first()->userable->name}})</a>

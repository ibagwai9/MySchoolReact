			...
			<td>
				...
				@if ($subcategory->newestThread)
					...
					<a href="{{ $subcategory->newestThread->route }}">
                        ...
                        ({{ \App\User::where('username', $subcategory->newestThread->authorName)->first()->userable->name}})
					...
					<a href="{{ $subcategory->latestActiveThread->lastPost->route }}">
                        ...
                        ({{ \App\User::where('username', $subcategory->latestActiveThread->lastPost->authorName)->first()->userable->name}})
			...
			@foreach ($category->threadsPaginated as $thread)
				<tr>
					<td>
						...
						<p>({{ \App\User::where('username', $thread->authorName)->first()->userable->name}}{{--{ $thread->authorName }}--}} <span class="text-muted">({{ $thread->posted }})</span></p>
					</td>
					<td class="text-right">
					    {{ $thread->viewCount }}
					</td>

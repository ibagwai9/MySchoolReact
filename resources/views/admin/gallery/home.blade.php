...
@section('admin-main-content')
    <h3><i class="fa fa-angle-right"></i> Manage Photos</h3>
        ...
        <div class="col-lg-12">
            ...
            @endif
                <div style="margin-top: 2%">
                    <a class="btn btn-success" href="{{ url('/photo/create') }}">Upload A Photo</a>
                </div>

                <div style="margin-top: 5%">
                    <h4 class="mb"><i class="fa fa-angle-right"></i> Manage Existing Uploads</h4>
                        <h5>(Choose a Date Range)</h5>
                </div>

                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/photo/filtered') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name ='news_month_from' class = "form-control">
                                    @foreach(App\NewsBoard::$months as $key => $value)
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-danger" href="{{ url('/photo/all') }}">Manage All Photos</a>
                            </div>
                        </div>
                    </form>
                </div>
